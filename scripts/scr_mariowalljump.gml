...
**
**  Returns:
**      The sprite_index of Mario's wall jump sprite based on the current powerup.
*/
switch global.powerup
{
    ...
    case cs_crown: return spr_px_peach_skid
    case cs_goldtan: return spr_mario_goldtan_skid
    case cs_cat: return spr_mario_cat_walljump
}
